const buttonHomeRules = document.getElementById('rules-button-home');
const buttonVolumeRules = document.getElementById('rules-button-volume');

buttonHomeRules.addEventListener('click', function() {
  pageRules.style.display = 'none';
  pageMenu.style.display = 'flex';
});

buttonVolumeRules.addEventListener('click', function() {
  if (volume == true) {
    volume = false;
